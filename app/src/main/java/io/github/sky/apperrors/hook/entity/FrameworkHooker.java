 ...
 */
package io.github.sky.apperrors.hook.entity;
...
import io.github.sky.apperrors.ui.activity.errors.AppErrorsDetailActivity;
...
public class FrameworkHooker {
    ...
    static final String ACTION_GET_ERRORS = "io.github.sky.apperrors.action.GET_ERRORS";
    static final String ACTION_ERRORS_RESULT = "io.github.sky.apperrors.action.ERRORS_RESULT";
    static final String ACTION_CLEAR_ERRORS = "io.github.sky.apperrors.action.CLEAR_ERRORS";
    static final String ACTION_REMOVE_ERROR = "io.github.sky.apperrors.action.REMOVE_ERROR";
    ...
    private static void sendCrashNotification(Context context, AppErrorsProcessData d, String appName, String errorTitle) {
        try {
            ...
            io.github.sky.apperrors.bean.AppErrorsInfoBean bean = null;
            for (io.github.sky.apperrors.bean.AppErrorsInfoBean b : AppErrorsRecordData.allData) {
                if (b.pid == d.pid()) { bean = b; break; }
            }
            if (bean == null) {
                ApplicationInfo ai = d.appInfo();
                bean = io.github.sky.apperrors.bean.AppErrorsInfoBean.clone(context, d.pid(), d.userId(),
