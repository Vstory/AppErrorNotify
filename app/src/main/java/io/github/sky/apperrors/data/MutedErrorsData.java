...
import io.github.sky.apperrors.bean.MutedErrorsAppBean;
...
public class MutedErrorsData {
    ...
    private static final String LOCAL_PREFS_NAME = "io.github.sky.apperrors_mute";
    ...
    public static final String ACTION_GET_MUTED = "io.github.sky.apperrors.action.GET_MUTED";
    public static final String ACTION_MUTED_RESULT = "io.github.sky.apperrors.action.MUTED_RESULT";
    public static final String ACTION_MUTE_ERROR = "io.github.sky.apperrors.action.MUTE_ERROR";
    public static final String ACTION_UNMUTE_ERROR = "io.github.sky.apperrors.action.UNMUTE_ERROR";
    public static final String ACTION_UNMUTE_ALL = "io.github.sky.apperrors.action.UNMUTE_ALL";
