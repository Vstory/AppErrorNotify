...
public class ModuleAppLocale {
    ...
    public static ModuleAppLocale attach(Context context) {
        return new ModuleAppLocale(() -> io.github.vstory.apperrors.utils.tool.LanguageData.resolveResources(context));
    }
    ...
    public String getCrashAutoSuppressTip(String appName) { return str(R.string.crash_auto_suppress_tip, appName); }
    public String getCrashAutoSuppressNoticeTitle() { return str(R.string.crash_auto_suppress_notice_title); }
    public String getCrashAutoSuppressNoticeContent(String appName) { return str(R.string.crash_auto_suppress_notice_content, appName); }
    public String getCrashAutoSuppressResume() { return str(R.string.crash_auto_suppress_resume); }
    public String getCrashAutoSuppressResumed(String appName, String pkg) { return str(R.string.crash_auto_suppress_resumed, appName, pkg); }
