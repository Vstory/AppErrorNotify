...
public class MutedErrorsData {
    ...
    public static final String ACTION_UNMUTE_ERROR = "io.github.vstory.apperrors.action.UNMUTE_ERROR";
    public static final String ACTION_UNMUTE_ALL = "io.github.vstory.apperrors.action.UNMUTE_ALL";
