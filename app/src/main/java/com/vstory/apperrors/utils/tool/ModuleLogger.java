...
public class ModuleLogger {
    ...
    private static final String LOCAL_PREFS_NAME = "com.vstory.apperrors_logs";
    ...
    public static final String ACTION_GET_LOGS = "com.vstory.apperrors.action.GET_LOGS";
    public static final String ACTION_LOGS_RESULT = "com.vstory.apperrors.action.LOGS_RESULT";
